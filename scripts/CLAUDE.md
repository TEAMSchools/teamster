...
| `cube-rest-mcp-launch.sh`                     | MCP launcher: fetch `CUBEJS_API_SECRET`, derive user email via `gh api user --jq .login`, exec `cube_rest_mcp.py` |
...
Reference implementation: [`cube_rest_mcp.py`](cube_rest_mcp.py). Pattern:
