...
| Partial rounds                                                            | Hold them out everywhere, including the bars                                                                                                                                      | Decided, not built. Open: whether it also applies at Measure Standard and Measure granularity, where a partial-round student still gets a verdict on each measure they sat |
