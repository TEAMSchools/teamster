...
full_tables = ScheduleDefinition(
    ...
    run_config=config_from_files(
        ["./teamster/local/config/powerschool/api/query-full.yaml"]
    ),
    tags={
        "dagster-k8s/config": {
            "container_config": {
...
filtered_tables = ScheduleDefinition(
    ...
    execution_timezone=LOCAL_TIME_ZONE,
    run_config=config_from_files(
        ["./teamster/local/config/powerschool/api/query-filtered.yaml"]
    ),
    tags={
        "dagster-k8s/config": {
            "container_config": {
...
custom_tables = ScheduleDefinition(
    ...
    execution_timezone=LOCAL_TIME_ZONE,
    run_config=config_from_files(
        ["./teamster/local/config/powerschool/api/query-custom.yaml"]
    ),
    tags={
        "dagster-k8s/config": {
            "container_config": {
...
contacts_tables = ScheduleDefinition(
    ...
    execution_timezone=LOCAL_TIME_ZONE,
    run_config=config_from_files(
        ["./teamster/local/config/powerschool/api/query-contacts.yaml"]
    ),
    tags={
        "dagster-k8s/config": {
            "container_config": {
...
attendance_tables = ScheduleDefinition(
    ...
    execution_timezone=LOCAL_TIME_ZONE,
    run_config=config_from_files(
        ["./teamster/local/config/powerschool/api/query-attendance.yaml"]
    ),
    tags={
        "dagster-k8s/config": {
            "container_config": {
...
assignment_tables = ScheduleDefinition(
    ...
    execution_timezone=LOCAL_TIME_ZONE,
    run_config=config_from_files(
        ["./teamster/local/config/powerschool/api/query-assignments.yaml"]
    ),
    tags={
        "dagster-k8s/config": {
            "container_config": {
...
assignmentscore = ScheduleDefinition(
    ...
    execution_timezone=LOCAL_TIME_ZONE,
    run_config=config_from_files(
        ["./teamster/local/config/powerschool/api/query-assignmentscore.yaml"]
    ),
    tags={
        "dagster-k8s/config": {
            "container_config": {
