...
employee_memberships = build_sftp_file_asset(
    asset_key=[*key_prefix, "employee_memberships"],
    remote_file_regex=r"employee_memberships\.csv",
    avro_schema=EMPLOYEE_MEMBERSHIPS_SCHEMA,
    **asset_kwargs,
)
