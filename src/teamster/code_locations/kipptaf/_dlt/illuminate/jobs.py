...
illuminate_dlt_hourly_asset_job = define_asset_job(
    name=f"{CODE_LOCATION}__dlt__illuminate__hourly_asset_job",
    selection=[
...
illuminate_dlt_daily_asset_job = define_asset_job(
