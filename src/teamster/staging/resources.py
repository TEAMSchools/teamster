...
SLING_RESOURCE = SlingResource(
    connections=[
        SlingConnectionResource(
            type="postgres",
            name="POSTGRES_ILLUMINATE",
            host="osage-orange.allthedata.com",
            user="kippteamschools",
            password=EnvVar("ILLUMINATE_DB_PASSWORD"),
            database="kippteamschools",
            sslmode="require",
        ),
        SlingConnectionResource(
            type="bigquery",
