...
`sftp.titank12.com` for new files. Lists via
`SSHResource.listdir_attr_r_or_skip`, which turns a transient connection failure
into a `SkipReason`. Non-partitioned assets only.
