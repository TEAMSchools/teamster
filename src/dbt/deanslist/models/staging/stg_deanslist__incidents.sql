...
select
    ...
    dl_lastupdate.timezone_type as `dl_lastupdate_timezone_type`,
    nullif(dl_lastupdate.timezone, '') as `dl_lastupdate_timezone`,
    safe_cast(nullif(dl_lastupdate.date, '') as datetime) as `dl_lastupdate_date`,
