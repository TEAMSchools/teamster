with
    adp_df_union as (
        select
            ...
            is_current_record,
            worker_id__id_value as worker_id,
            worker_dates__original_hire_date as worker_original_hire_date,
            worker_dates__rehire_date as worker_rehire_date,
            worker_dates__termination_date as worker_termination_date,
            worker_status__status_code__code_value as worker_status_code,
            work_assignment__termination_date as work_assignment_termination_date,
            work_assignment__actual_start_date as work_assignment_actual_start_date,
            person__formatted_name as formatted_name,
            person__family_name_1 as family_name_1,
            person__given_name as given_name,
            person__legal_name__formatted_name as legal_formatted_name,
            person__legal_name__family_name_1 as legal_family_name,
            person__legal_name__given_name as legal_given_name,
            person__birth_date as birth_date,
            person__race_code_name as race_code,
            person__ethnicity_code_name as ethnicity_code,
            person__gender_code_name as gender_code,
            person__legal_address__city_name as legal_address_city_name,
            person__legal_address__country_subdivision_level_1__code_value
            as legal_address_country_subdivision_level_1_code,
            person__legal_address__line_one as legal_address_line_one,
            person__legal_address__postal_code as legal_address_postal_code,
            is_prestart,
            item_id,
            position_id,
            job_title,
            ...
            assignment_status__status_code__name as assignment_status,
            assignment_status__status_code__name__lag as assignment_status_lag,
            assignment_status__effective_date as assignment_status_effective_date,
            assignment_status__reason_code__name as assignment_status_reason,
            home_work_location__name_code__name as home_work_location_name,
            worker_type_code__name as worker_type_code,
            wage_law_coverage__wage_law_name_code__name as wage_law_name,
            wage_law_coverage__coverage_code__name as wage_law_coverage,
            base_remuneration__annual_rate_amount__amount_value
            as base_remuneration_annual_rate_amount,
            additional_remunerations__rate__amount_value__sum
            as additional_remunerations_rate_amount,
            communication__personal_cell__formatted_number as personal_cell,
            communication__personal_email__email_uri as personal_email,
            communication__work_cell__formatted_number as work_cell,
            communication__work_email__email_uri as work_email,
            custom_field__employee_number,
            wf_mgr_accrual_profile,
            wf_mgr_badge_number,
            wf_mgr_ee_type,
            wf_mgr_pay_rule,
            wf_mgr_trigger,
            ...
            organizational_unit__assigned__business_unit__name
            as assigned_business_unit_name,
            organizational_unit__assigned__department__name as assigned_department_name,
            organizational_unit__home__business_unit__code_value
            as home_business_unit_code,
            organizational_unit__home__business_unit__name as home_business_unit_name,
            organizational_unit__home__department__name as home_department_name,
            reports_to_worker_id__id_value as reports_to_worker_id,
            ...
            if(
                effective_date_start < '2021-01-01', '2021-01-01', effective_date_start
        ...
        from {{ ref("int_adp_workforce_now__workers") }}
        /* after transistion from Dayforce */
        where effective_date_end >= '2021-01-01'
...
select
    ...
    coalesce(w.employee_number, en.employee_number) as employee_number,

    coalesce(
        idps.powerschool_teacher_number,
        cast(w.employee_number as string),
        cast(en.employee_number as string)
...
left join
    ...
    on coalesce(w.employee_number, en.employee_number) = ldap.employee_number
left join
    {{ ref("stg_people__powerschool_crosswalk") }} as idps
    on coalesce(w.employee_number, en.employee_number) = idps.employee_number
    and idps.is_active
left join
    {{ ref("int_surveys__staff_information_survey_pivot") }} as sis
    on coalesce(w.employee_number, en.employee_number) = sis.employee_number
left join
