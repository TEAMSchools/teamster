...
left join
    ...
    and rt.type = 'IR'
left join
    {{ ref("stg_google_sheets__iready_crosswalk") }} as cwo
...
left join
    {{ ref("stg_google_sheets__iready_crosswalk") }} as cwr
...
left join
    {{ ref("stg_google_sheets__iready_crosswalk") }} as cwt
...
left join
    {{ ref("stg_google_sheets__iready_crosswalk") }} as cws
...
left join
    {{ ref("stg_google_sheets__iready_crosswalk") }} as cwi
...
left join
    {{ ref("stg_google_sheets__iready_crosswalk") }} as cwp
