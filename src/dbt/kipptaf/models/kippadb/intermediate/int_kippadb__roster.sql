with
    ...
    roster as (
        select
            ...
            se.contact_1_relationship as ps_contact_1_relationship,
            se.contact_1_phone_daytime as ps_contact_1_phone_daytime,
            se.contact_1_phone_home as ps_contact_1_phone_home,
            se.contact_1_phone_work as ps_contact_1_phone_work,
            se.contact_2_name as ps_contact_2_name,
            se.contact_2_relationship as ps_contact_2_relationship,
            se.contact_2_email_current as ps_contact_2_email_current,
            se.contact_2_phone_daytime as ps_contact_2_phone_daytime,
            se.contact_2_phone_home as ps_contact_2_phone_home,
            se.contact_2_phone_mobile as ps_contact_2_phone_mobile,
            se.contact_2_phone_primary as ps_contact_2_phone_primary,
            se.contact_2_phone_work as ps_contact_2_phone_work,
            se.emergency_1_name as ps_emergency_contact_1_name,
            se.emergency_1_relationship as ps_emergency_contact_1_relationship,
            se.emergency_1_phone_daytime as ps_emergency_contact_1_phone_daytime,
            se.emergency_1_phone_home as ps_emergency_contact_1_phone_home,
            se.emergency_1_phone_mobile as ps_emergency_contact_1_phone_mobile,
            se.emergency_1_phone_primary as ps_emergency_contact_1_phone_primary,
            se.emergency_2_name as ps_emergency_contact_2_name,
            se.emergency_2_relationship as ps_emergency_contact_2_relationship,
            se.emergency_2_phone_daytime as ps_emergency_contact_2_phone_daytime,
            se.emergency_2_phone_home as ps_emergency_contact_2_phone_home,
            se.emergency_2_phone_mobile as ps_emergency_contact_2_phone_mobile,
            se.emergency_2_phone_primary as ps_emergency_contact_2_phone_primary,
            se.emergency_3_name as ps_emergency_contact_3_name,
            se.emergency_3_relationship as ps_emergency_contact_3_relationship,
            se.emergency_3_phone_daytime as ps_emergency_contact_3_phone_daytime,
            se.emergency_3_phone_home as ps_emergency_contact_3_phone_home,
            se.emergency_3_phone_mobile as ps_emergency_contact_3_phone_mobile,
            se.emergency_3_phone_primary as ps_emergency_contact_3_phone_primary,
            se.region,
