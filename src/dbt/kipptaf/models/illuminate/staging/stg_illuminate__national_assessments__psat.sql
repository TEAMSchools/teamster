with
    union_relations as (
        {{
            dbt_utils.union_relations(
                relations=[
                    source("illuminate_national_assessments", "psat_2023"),
                    source("illuminate_national_assessments", "psat_2024"),
                ]
            )
        }}
    ),
    ...
    combined_years as (
        select
            ...
            coalesce(
                psat_2023_district_student_id, psat_2024_district_student_id
            ) as district_student_id,
            coalesce(
                psat_2023_local_student_id, psat_2024_local_student_id
            ) as local_student_id,
            coalesce(
                psat_2023_state_student_id, psat_2024_state_student_id
            ) as state_student_id,
            ...
            coalesce(
                psat_2023_student_first_name, psat_2024_student_first_name
            ) as student_first_name,
            coalesce(
                psat_2023_student_last_name, psat_2024_student_last_name
            ...
            nullif(psat_2023_newdistrict_id, '') as psat_2023_newdistrictid,
            ...
            nullif(
                psat_2023_student_middle_initial, ''
            ...
            nullif(psat_2024_newdistrict_id, '') as psat_2024_newdistrictid,
            ...
            nullif(
                psat_2024_student_middle_initial, ''
