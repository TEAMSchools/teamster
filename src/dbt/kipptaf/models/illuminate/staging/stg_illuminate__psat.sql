select
    ...
    psat_2023_commandevidencesubscore as command_evidence_subscore,
    psat_2023_commandreppercentile as command_rep_percentile,
    psat_2023_commandusrpercentile as command_usr_percentile,

    psat_2023_ebreadwritesectionscore as eb_read_write_section_score,
    ...
    psat_2023_englishconvsubscore as english_conv_subscore,
    ...
    psat_2023_expressionideassubscore as expression_ideas_subscore,
    ...
    psat_2023_heartalgebrasubscore as heart_algebra_subscore,

    psat_2023_historycrosstestscore as history_cross_test_score,
    psat_2023_histreppercentile as hist_rep_percentile,
    psat_2023_histusrpercentile as hist_usr_percentile,

    psat_2023_mathtestscore as math_test_score,
    ...
    psat_2023_readingtestscore as reading_test_score,
    psat_2023_readingreppercentile as reading_rep_percentile,
    psat_2023_readingusrpercentile as reading_usr_percentile,

    psat_2023_relevantwordssubscore as relevant_words_subscore,

    psat_2023_sciencecrosstestscore as science_cross_test_score,
    ...
    psat_2023_writingtestscore as writing_test_score,
    ...
    psat_2023_aparthist as ap_arthist,
    psat_2023_apbio as ap_bio,
    psat_2023_apcalc as ap_calc,
    psat_2023_apchem as ap_chem,
    psat_2023_apcompgovpol as ap_compgovpol,
    psat_2023_apcompsci as ap_compsci,
    psat_2023_apenglang as ap_englang,
    psat_2023_apenglit as ap_englit,
    psat_2023_apenvsci as ap_envsci,
    psat_2023_apeurohist as ap_eurohist,
    psat_2023_aphumgeo as ap_humgeo,
    psat_2023_apmacecon as ap_macecon,
    psat_2023_apmicecon as ap_micecon,
    psat_2023_apmusic as ap_music,
    psat_2023_apphysi as ap_physi,
    psat_2023_apphysii as ap_physii,
    psat_2023_apphysmag as ap_physmag,
    psat_2023_apphysmech as ap_physmech,
    psat_2023_appsych as ap_psych,
    psat_2023_apseminar as ap_seminar,
    psat_2023_apstat as ap_stat,
    psat_2023_apusgovpol as ap_usgovpol,
    psat_2023_apushist as ap_ushist,
    psat_2023_apworldhist as ap_worldhist,
