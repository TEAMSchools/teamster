...
select
    ...
    assignment_status__reason_code__code_value,
    assignment_status__reason_code__long_name,
    assignment_status__reason_code__short_name,
    payroll_processing_status_code__code_value,
    payroll_processing_status_code__long_name,
    payroll_processing_status_code__short_name,
    base_remuneration__annual_rate_amount__currency_code,
    base_remuneration__annual_rate_amount__name_code__code_value,
    base_remuneration__annual_rate_amount__name_code__long_name,
    base_remuneration__annual_rate_amount__name_code__short_name,
    base_remuneration__pay_period_rate_amount__currency_code,
    base_remuneration__pay_period_rate_amount__name_code__code_value,
    base_remuneration__pay_period_rate_amount__name_code__long_name,
    base_remuneration__pay_period_rate_amount__name_code__short_name,
    base_remuneration__hourly_rate_amount__currency_code,
    base_remuneration__hourly_rate_amount__name_code__code_value,
    base_remuneration__hourly_rate_amount__name_code__long_name,
    base_remuneration__hourly_rate_amount__name_code__short_name,
    base_remuneration__daily_rate_amount__currency_code,
    base_remuneration__daily_rate_amount__name_code__code_value,
    base_remuneration__daily_rate_amount__name_code__long_name,
    base_remuneration__daily_rate_amount__name_code__short_name,
    ...
    home_work_location__address__item_id,
    home_work_location__address__line_one,
    home_work_location__address__line_two,
    home_work_location__address__line_three,
    home_work_location__address__city_name,
    home_work_location__address__postal_code,
    home_work_location__address__country_code,
    home_work_location__address__country_subdivision_level_1__subdivision_type,
    home_work_location__address__country_subdivision_level_1__code_value,
    home_work_location__address__country_subdivision_level_1__long_name,
    home_work_location__address__country_subdivision_level_1__short_name,
    home_work_location__address__country_subdivision_level_2__subdivision_type,
    home_work_location__address__country_subdivision_level_2__code_value,
    home_work_location__address__country_subdivision_level_2__long_name,
    home_work_location__address__country_subdivision_level_2__short_name,
    home_work_location__address__name_code__code_value,
    home_work_location__address__name_code__long_name,
    home_work_location__address__name_code__short_name,
    home_work_location__address__type_code__code_value,
    home_work_location__address__type_code__long_name,
    home_work_location__address__type_code__short_name,
    ...
    standard_pay_period_hours__hours_quantity,
    standard_hours__hours_quantity,
    standard_hours__unit_code__code_value,
    standard_hours__unit_code__long_name,
    standard_hours__unit_code__short_name,
    wage_law_coverage__coverage_code__code_value,
    wage_law_coverage__coverage_code__long_name,
    wage_law_coverage__coverage_code__short_name,
    wage_law_coverage__wage_law_name_code__code_value,
    wage_law_coverage__wage_law_name_code__long_name,
    wage_law_coverage__wage_law_name_code__short_name,
    worker_time_profile__badge_id,
    worker_time_profile__time_and_attendance_indicator,
    worker_time_profile__time_zone_code,
    worker_time_profile__time_service_supervisor__associate_oid,
    worker_time_profile__time_service_supervisor__position_id,
    worker_time_profile__time_service_supervisor__worker_id__id_value,
    worker_time_profile__time_service_supervisor__reports_to_worker_name__formatted_name,
    worker_time_profile__time_service_supervisor__reports_to_worker_name__family_name1,
    worker_time_profile__time_service_supervisor__reports_to_worker_name__given_name,
    worker_time_profile__time_service_supervisor__reports_to_worker_name__middle_name,
    worker_type_code__code_value,
    worker_type_code__long_name,
    worker_type_code__short_name,
    additional_remunerations,
    assigned_organizational_units,
    assigned_work_locations,
    ...
    seniority_date,
    termination_date,
    base_remuneration__annual_rate_amount__amount_value,
    base_remuneration__hourly_rate_amount__amount_value,
    base_remuneration__daily_rate_amount__amount_value,
    base_remuneration__pay_period_rate_amount__amount_value,
    assignment_status__effective_date,
    assignment_status__status_code__effective_date,
    assignment_status__reason_code__effective_date,
    payroll_processing_status_code__effective_date,
    base_remuneration__effective_date,
    base_remuneration__annual_rate_amount__name_code__effective_date,
    base_remuneration__pay_period_rate_amount__name_code__effective_date,
    base_remuneration__hourly_rate_amount__name_code__effective_date,
    base_remuneration__daily_rate_amount__name_code__effective_date,
    home_work_location__address__country_subdivision_level_1__effective_date,
    home_work_location__address__country_subdivision_level_2__effective_date,
    home_work_location__address__name_code__effective_date,
    ...
    wage_law_coverage__wage_law_name_code__effective_date,
    worker_type_code__effective_date,
    surrogate_key,
