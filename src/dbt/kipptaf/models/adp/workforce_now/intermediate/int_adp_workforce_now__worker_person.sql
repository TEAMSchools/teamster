select
    ...
    w.work_assignment_assignment_status_long_name_prev as assignment_status_prev,
    ...
    w.group_name as worker_group_name,

    w.organizational_unit_business_unit_home_name as business_unit_home_code,
    w.organizational_unit_business_unit_assigned_name as business_unit_assigned_code,
    ...
    w.organizational_unit_department_home_name as department_home_code,
    w.organizational_unit_department_assigned_name as department_assigned_code,
    ...
    w.business_unit_assigned_name,
    w.business_unit_home_name,
    w.custom_miami_aces_number,
    w.department_assigned_name,
    ...
    p.preferred_name_given_name,
    p.preferred_name_middle_name,
    p.preferred_name_family_name,
    p.preferred_name_lastfirst,
    p.race_ethnicity_reporting,

    rt.preferred_name_given_name as report_to_preferred_name_given_name,
    rt.preferred_name_family_name as report_to_preferred_name_family_name,
    rt.preferred_name_lastfirst as report_to_preferred_name_lastfirst,
