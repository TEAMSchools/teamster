with
    ...
    response_union as (
        ...
        select
            ...
            years_teaching_in_njfl,
            years_teaching_outside_njfl,
            cast(fl_cert_expiration_1 as date) as fl_cert_expiration_1,
            cast(nj_cert_issue_date_1 as date) as nj_cert_issue_date_1,
            cast(nj_cert_issue_date_2 as date) as nj_cert_issue_date_2,
            cast(nj_cert_issue_date_3 as date) as nj_cert_issue_date_3,
            cast(cert_required as boolean) as cert_required,
            cast(fl_additional_cert_1 as boolean) as fl_additional_cert_1,
            cast(nj_cert_additional_1 as boolean) as nj_cert_additional_1,
            ...
            race_ethnicity,
            relay_status,
        from {{ source("surveys", "src_surveys__staff_info_certification") }}
    )
