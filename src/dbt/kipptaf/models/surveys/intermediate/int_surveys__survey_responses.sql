...
select
    ...
    sr.campaign_name as code,
    sr.campaign_name as type,
    sr.campaign_fiscal_year as academic_year,
...
left join
    ...
    and date(sr.response_date_submitted) between rt.start_date and rt.end_date
inner join
