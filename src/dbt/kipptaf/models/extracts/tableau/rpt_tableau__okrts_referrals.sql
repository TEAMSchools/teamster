    ...
    okrts_referrals as (
        select
            ...
            case
                ...
                then 'Social Work'
                when
                    (left(dli.category, 2) = 'TX' or dli.category like 'Documentation%')
                then 'Non-Behavioral'
...
select
    ...
    is_week_ytd,
    is_suspended_y1_int,
    is_suspended_y1_oss_int,
    is_suspended_y1_iss_int,
    rn_student_year,
    is_suspended_y1_one_int,
    is_suspended_y1_oss_one_int,
    is_suspended_y1_iss_one_int,
    is_suspended_y1_2plus_int,
    is_suspended_y1_oss_2plus_int,
    is_suspended_y1_iss_2plus_int,
    rn_incident,
