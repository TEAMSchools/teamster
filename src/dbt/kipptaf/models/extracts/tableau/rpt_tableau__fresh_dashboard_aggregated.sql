...
-- offers ever for region/grade level
select
    s.academic_year,
    s.org,
    s.region,
...
left join
    ...
    and f.finalsite_id = d.finalsite_id
    and f.grouped_status = d.grouped_status
where s.goal_type = 'Offers' and s.goal_granularity = 'Region/Grade Level'

union all

-- offers ever for school/grade level
select
    s.academic_year,
    s.org,
    s.region,
...
left join
    ...
    and f.finalsite_id = d.finalsite_id
    and f.grouped_status = d.grouped_status
where s.goal_type = 'Offers' and s.goal_granularity = 'School/Grade Level'

union all

-- offers ever for school
select
    s.academic_year,
    s.org,
    s.region,
...
left join
    ...
    and f.finalsite_id = d.finalsite_id
    and f.grouped_status = d.grouped_status
where s.goal_type = 'Offers' and s.goal_granularity = 'School'
