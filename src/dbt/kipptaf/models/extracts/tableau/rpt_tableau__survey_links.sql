        ...
        select
            ...
            replace(
                concat(
                    ...
                    '&entry.2102492257=',
                    replace(
                        coalesce(r.community_grew_up, ''), ', ', '&entry.2102492257='
                    ),
                    /* Community Work Exp */
                    '&entry.1197736651=',
                    replace(
                        coalesce(r.community_professional_exp, ''),
                        ', ',
                        '&entry.1197736651='
                    ),
                    /* languages spoken */
                    '&entry.1551531542=',
                    replace(
                        coalesce(r.languages_spoken, ''), ',', '&entry.1551531542='
                    ),
                    ...
                    '&entry.1130804124=',
                    replace(
                        coalesce(r.path_to_education, ''), ',', '&entry.1130804124='
                    ),
                    if(
                        r.job_title in (
                            'Teacher',
