...
left join
    ...
    and slm.region = e1.region
    and slm.school_level = e1.school_level
    and slm.credit_type = e1.credit_type
    and slm.is_quarter_end_date_range = e1.is_quarter_end_date_range
    and e1.view_name = 'teacher_scaffold'
    and e1.cte is null
/* temporarily remove rows from the entire gradebook audit dash when EOQ is false
...
left join
    ...
    and slm.school_level = e2.school_level
    and slm.course_number = e2.course_number
    and slm.is_quarter_end_date_range = e2.is_quarter_end_date_range
    and e2.view_name = 'teacher_scaffold'
    and e2.cte is null
