...
select
    ...
    a.is_pathways,
    a.iep_status,
    a.is_counseling_services,
    a.is_student_athlete,
    a.tutoring_nj,
    a.nj_student_tier,
    a.ada,
    a.ada_above_or_at_80,
    a.advisory,
    a.advisor_name,
    a.hos,
    a.semester,
    ...
    a.course_number,
    a.section_number,
    a.external_expression,
    a.section_or_period,
    a.credit_type,
    a.teacher_number,
    a.teacher_name,
    a.exclude_from_gpa,
    a.quarter_course_percent_grade_that_matters,
    a.quarter_course_grade_points_that_matters,
    a.quarter_citizenship,
    a.quarter_comment_value,
    a.category_quarter_percent_grade,
    a.category_quarter_average_all_courses,
    a.week_number_quarter as audit_qt_week_number,
    a.week_start_date as audit_start_date,
    a.week_end_date as audit_end_date,
    a.school_week_start_date_lead as audit_due_date,
    a.assignment_category_code as expected_teacher_assign_category_code,
    a.assignment_category_name as expected_teacher_assign_category_name,
    a.expectation as audit_category_exp_audit_week_ytd,
    a.assignmentid as teacher_assign_id,
    a.assignment_name as teacher_assign_name,
    ...
    a.teacher_assign_count,
    a.teacher_running_total_assign_by_cat,
    a.teacher_avg_score_for_assign_per_class_section_and_assign_id,
    a.total_expected_actual_graded_assignments_by_cat_qt_audit_week_all_courses,
    a.total_expected_graded_assignments_by_cat_qt_audit_week_all_courses,
    a.total_expected_actual_graded_assignments_by_course_cat_qt_audit_week,
    a.total_expected_graded_assignments_by_course_cat_qt_audit_week,
    a.total_expected_actual_graded_assignments_by_course_assign_id_qt_audit_week,
    a.total_expected_graded_assignments_by_course_assign_id_qt_audit_week,
    a.percent_graded_completion_by_cat_qt_audit_week_all_courses,
    a.percent_graded_completion_by_cat_qt_audit_week,
    a.percent_graded_completion_by_assign_id_qt_audit_week,
    a.qt_teacher_no_missing_assignments,
    a.qt_teacher_s_total_less_200,
    a.date_enrolled as student_course_entry_date,
    a.scorepoints as assign_score_raw,
    a.score_converted as assign_score_converted,
    a.totalpointvalue as assign_max_score,
    a.assign_final_score_percent,
    a.isexempt as assign_is_exempt,
    a.islate as assign_is_late,
    a.ismissing as assign_is_missing,

    audit_flag_name,

    r.sam_account_name as username,
...
left join
    {{ ref("base_people__staff_roster") }} as r on a.teacher_number = r.employee_number
