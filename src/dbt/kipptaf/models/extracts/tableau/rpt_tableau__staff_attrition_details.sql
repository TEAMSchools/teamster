    ...
    combined_statuses as (
        ...
        select
            ...
            coalesce(
                ...
                srh.effective_date_start as termination_date
                from denom as dc
                inner join
                    {{ ref("int_people__staff_roster_history") }} as srh
                    on dc.employee_number = srh.employee_number
            ...
            ly_active as (
                ...
                inner join
                    ...
                    and srh.job_title != 'Intern'
                    and srh.assignment_status
                    not in ('Pre-Start', 'Terminated', 'Deceased')
                left join
        ...
        select distinct
            ...
            l.additional_remunerations_rate_amount
            as additional_remuneration_rate_amount_value,
