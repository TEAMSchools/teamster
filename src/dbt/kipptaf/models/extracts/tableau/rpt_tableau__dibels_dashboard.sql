...
(
     select e._dbt_source_relation
           ...
           ,case when cast(e.grade_level as string) = '0' then 'K'
                 else cast(e.grade_level as string) end as enrollment_grade_level
           ,case when is_out_of_district = true then 1
                 else 0 end as ood
           ,e.gender as gender
           ,e.ethnicity as ethnicity
           ,case when e.is_homeless = true then 1
                 else 0 end as homeless
           ,case when e.is_504 = true then 1
                 else 0 end as is_504
           ,case when e.spedlep in ('no iEp',null) then 0
                      else 1 end as sped
           ,case when e.lep_status = true then 1
                 else 0 end as lep
           ,lunch_application_status as lunch_status
     from {{ ref("base_powerschool__student_enrollments") }} as e
     where academic_year = 2022 and enroll_status = 0 and rn_year = 1 and grade_level <= 4
),
...
(
      select left(bss.school_year,4) as mclass_academic_year --needed to extract the academic year format that matches nJ's syntax
      ...
      from {{ ref("stg_amplify__benchmark_student_summary") }} as bss
      inner join {{ ref("int_amplify__benchmark_student_summary_unpivot") }} as u
      on bss.surrogate_key = u.surrogate_key
...
select b.enrollment_academic_year
      ...
      --participation rates by school_course_section
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,b.expected_test) as participation_school_course_section_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,b.expected_test) as participation_school_course_section_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,b.expected_test) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,b.expected_test) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,b.expected_test) end),4) as participation_school_course_section_Bm_pm_period_percent

      --participation rates by school_course
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test) as participation_school_course_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test) as participation_school_course_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test) end),4) as participation_school_course_Bm_pm_period_percent

      --participation rates by school_grade
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,b.expected_test) as participation_school_grade_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,b.expected_test) as participation_school_grade_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,b.expected_test) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,b.expected_test) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,b.expected_test) end),4) as participation_school_grade_Bm_pm_period_percent

      --participation rates by school
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test) as participation_school_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test) as participation_school_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test) end),4) as participation_school_Bm_pm_period_percent

      --participation rates by region_grade
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,b.expected_test) as participation_region_grade_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,b.expected_test) as participation_region_grade_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,b.expected_test) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,b.expected_test) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,b.expected_test) end),4) as participation_region_grade_Bm_pm_period_percent

      --participation rates by region
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test) as participation_region_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test) as participation_region_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test) end),4) as participation_region_Bm_pm_period_percent

      --participation rates by district_grade
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,b.expected_test) as participation_district_grade_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,b.expected_test) as participation_district_grade_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,b.expected_test) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,b.expected_test) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,b.expected_test) end),4) as participation_district_grade_Bm_pm_period_percent

      --participation rates by district
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test) as participation_district_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test) as participation_district_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test) end),4) as participation_district_Bm_pm_period_percent

      --measure score met rates by school_course_section
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,b.expected_test,b.mclass_measure,b.mclass_measure_score) as measure_score_met_school_course_section_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,b.expected_test,b.mclass_measure) as measure_score_met_school_course_section_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,b.expected_test,b.mclass_measure,b.mclass_measure_score) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,
            b.expected_test,b.mclass_measure) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,b.expected_test,b.mclass_measure) end),4) as measure_score_met_school_course_section_Bm_pm_period_percent

      --measure score met rates by school_course
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test,b.mclass_measure,b.mclass_measure_score) as measure_score_met_school_course_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test,b.mclass_measure) as measure_score_met_school_course_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test,b.mclass_measure,b.mclass_measure_score) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test,b.mclass_measure) = 0 
            then null else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test,b.mclass_measure) end),4) as measure_score_met_school_course_Bm_pm_period_percent

      --measure score met rates by school_grade
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,b.expected_test,b.mclass_measure,b.mclass_measure_score) as measure_score_met_school_grade_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,b.expected_test,b.mclass_measure) as measure_score_met_school_grade_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,b.expected_test,b.mclass_measure,b.mclass_measure_score) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,
            b.expected_test,b.mclass_measure) = 0 then null else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,b.expected_test,b.mclass_measure) end),4) as measure_score_met_school_grade_Bm_pm_period_percent

      --measure score met rates by school
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test,b.mclass_measure,b.mclass_measure_score) as measure_score_met_school_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test,b.mclass_measure) as measure_score_met_school_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test,b.mclass_measure,b.mclass_measure_score) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test,b.mclass_measure) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test,b.mclass_measure) end),4) as measure_score_met_school_Bm_pm_period_percent

      --measure score met rates by region_grade
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,b.expected_test,b.mclass_measure,b.mclass_measure_score) as measure_score_met_region_grade_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,b.expected_test,b.mclass_measure) as measure_score_met_region_grade_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,b.expected_test,b.mclass_measure,b.mclass_measure_score) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,
            b.expected_test,b.mclass_measure) = 0 then null else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,b.expected_test,b.mclass_measure) end),4) as measure_score_met_region_grade_Bm_pm_period_percent

      --measure score met rates by region
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test,b.mclass_measure,b.mclass_measure_score) as measure_score_met_region_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test,b.mclass_measure) as measure_score_met_region_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test,b.mclass_measure,b.mclass_measure_score) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test,b.mclass_measure) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test,b.mclass_measure) end),4) as measure_score_met_region_Bm_pm_period_percent

      --measure score met rates by district_grade
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,b.expected_test,b.mclass_measure,b.mclass_measure_score) as measure_score_met_district_grade_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,b.expected_test,b.mclass_measure) as measure_score_met_district_grade_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,b.expected_test,b.mclass_measure,b.mclass_measure_score) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,
            b.expected_test,b.mclass_measure) = 0 then null else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,b.expected_test,b.mclass_measure) end),4) as measure_score_met_district_grade_Bm_pm_period_percent_met

      --measure score met rates by district
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test,b.mclass_measure,b.mclass_measure_score) as measure_score_met_district_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test,b.mclass_measure) as measure_score_met_district_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test,b.mclass_measure,b.mclass_measure_score) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test,b.mclass_measure) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test,b.mclass_measure) end),4) as measure_score_met_district_Bm_pm_period_percent

      --measure level met rates by school_course_section
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,b.expected_test,b.mclass_measure,b.mclass_measure_level) as measure_level_met_school_course_section_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,b.expected_test,b.mclass_measure) as measure_level_met_school_course_section_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,b.expected_test,b.mclass_measure,b.mclass_measure_level) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,
            b.expected_test,b.mclass_measure) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.section_number,b.expected_test,b.mclass_measure) end),4) as measure_level_met_school_course_section_Bm_pm_period_percent

      --measure level met rates by school_course
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test,b.mclass_measure,b.mclass_measure_level) as measure_level_met_school_course_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test,b.mclass_measure) as measure_level_met_school_course_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test,b.mclass_measure,b.mclass_measure_level) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test,b.mclass_measure) = 0 
            then null else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.course_name,b.expected_test,b.mclass_measure) end),4) as measure_level_met_school_course_Bm_pm_period_percent

      --measure level met rates by school_grade
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,b.expected_test,b.mclass_measure,b.mclass_measure_level) as measure_level_met_school_grade_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,b.expected_test,b.mclass_measure) as measure_level_met_school_grade_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,b.expected_test,b.mclass_measure,b.mclass_measure_level) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,
            b.expected_test,b.mclass_measure) = 0 then null else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.schedule_student_grade_level,b.expected_test,b.mclass_measure) end),4) as measure_level_met_school_grade_Bm_pm_period_percent

      --measure level met rates by school
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test,b.mclass_measure,b.mclass_measure_level) as measure_level_met_school_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test,b.mclass_measure) as measure_level_met_school_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test,b.mclass_measure,b.mclass_measure_level) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test,b.mclass_measure) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_school_id,b.expected_test,b.mclass_measure) end),4) as measure_level_met_school_Bm_pm_period_percent

      --measure level met rates by region_grade
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,b.expected_test,b.mclass_measure,b.mclass_measure_level) as measure_level_met_region_grade_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,b.expected_test,b.mclass_measure) as measure_level_met_region_grade_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,b.expected_test,b.mclass_measure,b.mclass_measure_level) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,
            b.expected_test,b.mclass_measure) = 0 then null else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.schedule_student_grade_level,b.expected_test,b.mclass_measure) end),4) as measure_level_met_region_grade_Bm_pm_period_percent

      --measure level met rates by region
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test,b.mclass_measure,b.mclass_measure_level) as measure_level_met_region_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test,b.mclass_measure) as measure_level_met_region_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test,b.mclass_measure,b.mclass_measure_level) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test,b.mclass_measure) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_region,b.expected_test,b.mclass_measure) end),4) as measure_level_met_region_Bm_pm_period_percent

      --measure level met rates by district_grade
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,b.expected_test,b.mclass_measure,b.mclass_measure_level) as measure_level_met_district_grade_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,b.expected_test,b.mclass_measure) as measure_level_met_district_grade_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,b.expected_test,b.mclass_measure,b.mclass_measure_level) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,
            b.expected_test,b.mclass_measure) = 0 then null else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.schedule_student_grade_level,b.expected_test,b.mclass_measure) end),4) as measure_level_met_district_grade_Bm_pm_period_percent

      --measure level met rates by district
      ,count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test,b.mclass_measure,b.mclass_measure_level) as measure_level_met_district_Bm_pm_period_total_students_assessed
      ,count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test,b.mclass_measure) as measure_level_met_district_Bm_pm_period_total_students_scheduled
      ,round(count(distinct b.mclass_student_number) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test,b.mclass_measure,b.mclass_measure_level) / (case when count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test,b.mclass_measure) = 0 then null 
            else count(distinct b.student_number_schedule) over (partition by b.schedule_academic_year,b.schedule_district,b.expected_test,b.mclass_measure) end),4) as measure_level_met_district_Bm_pm_period_percent

from
(
      select s.enrollment_academic_year
      ...
      on s.enrollment_academic_year = m.schedule_academic_year and s.student_number_enrollment = m.student_number_schedule
      left join assessments_scores as d
      on m.schedule_academic_year = d.mclass_academic_year and m.student_number_schedule = d.mclass_student_number and m.expected_test = d.mclass_period --this last join on field is to ensure rows are generated for all expected tests, even if the student did not assess for them
) as b
