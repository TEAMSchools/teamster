with
    roster as (
        ...
        left join
            {{ ref("stg_google_sheets__kippfwd_expected_assessments_archive") }} as t
    ...
    custom_scores as (
        select
            ...
            e.region as test_region,
            e.student_number as test_student_number,
            e.grade_level as test_grade_level,
