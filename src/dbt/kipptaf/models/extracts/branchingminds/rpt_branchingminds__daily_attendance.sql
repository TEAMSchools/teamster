...
where
    ...
    -- official first day of school per district -- real attendance rows
    -- exist before these dates for Newark/Paterson but predate their
    -- official start (Camden opened 8/19/26, Newark/Paterson 8/24/26)
    and fsad.date_key
    >= case dr.name when 'Camden' then date '2026-08-19' else date '2026-08-24' end
