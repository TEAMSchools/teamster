...
left join
    {{ ref("stg_egencia__traveler_groups") }} as tg
...
left join
    {{ ref("stg_egencia__traveler_groups") }} as tg2
...
left join
    {{ ref("stg_egencia__traveler_groups") }} as tg3
...
left join
    {{ ref("stg_egencia__travel_managers") }} as tm
