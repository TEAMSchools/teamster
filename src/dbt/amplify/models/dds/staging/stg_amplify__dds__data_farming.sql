with
    data_farming as (
        select
            ...
            coalesce(
                form_maze_7th_beginning, form_maze_8th_beginning
            ) as form_maze_beginning,
            ...
            coalesce(
                form_orf_7th_beginning, form_orf_8th_beginning
            ) as form_orf_beginning,
            ...
            coalesce(
                composite_7th_beginning, composite_8th_beginning
            ) as composite_beginning,
            ...
            coalesce(
                benchmark_status_composite_7th_middle,
                benchmark_status_composite_8th_middle
            ...
            coalesce(
                benchmark_status_maze_adjusted_7th_end,
                benchmark_status_maze_adjusted_8th_end
            ...
            coalesce(
                benchmark_status_orf_accuracy_7th_end,
                benchmark_status_orf_accuracy_8th_end
            ...
            coalesce(
                maze_correct_7th_middle, maze_correct_8th_middle
            ) as maze_correct_middle,
            ...
            coalesce(
                maze_incorrect_7th_end, maze_incorrect_8th_end
            ) as maze_incorrect_end,

            coalesce(
                orf_accuracy_7th_beginning, orf_accuracy_8th_beginning
            ) as orf_accuracy_beginning,
            coalesce(
                orf_accuracy_7th_middle, orf_accuracy_8th_middle
            ) as orf_accuracy_middle,
            ...
            coalesce(
                remote_maze_7th_middle, remote_maze_8th_middle
            ) as remote_maze_middle,
            ...
            coalesce(
                district_percentile_composite_7th_end,
                district_percentile_composite_8th_end
            ...
            coalesce(
                district_percentile_orf_errors_7th_end,
                district_percentile_orf_errors_8th_end
            ...
            coalesce(
                school_percentile_composite_7th_middle,
                school_percentile_composite_8th_middle
            ...
            coalesce(
                school_percentile_maze_adjusted_7th_end,
                school_percentile_maze_adjusted_8th_end
            ...
            coalesce(
                school_percentile_maze_correct_7th_end,
                school_percentile_maze_correct_8th_end
            ...
            coalesce(
                school_percentile_orf_accuracy_7th_end,
                school_percentile_orf_accuracy_8th_end
            ...
            coalesce(
                school_percentile_orf_errors_7th_middle,
                school_percentile_orf_errors_8th_middle
            ) as school_percentile_orf_errors_middle,
            coalesce(
                school_percentile_orf_errors_7th_end,
                school_percentile_orf_errors_8th_end
            ...
            parse_date(
                '%Y/%m/%d',
                coalesce(date_composite_7th_beginning, date_composite_8th_beginning)
            ) as date_composite_beginning,
            parse_date(
                '%Y/%m/%d',
                coalesce(date_composite_7th_middle, date_composite_8th_middle)
        ...
        from {{ source("amplify_dds", "data_farming") }}
    )

select
    *,

    date_maze_beginning as date_maze_adjusted_beginning,
    date_maze_beginning as date_maze_correct_beginning,
    date_maze_beginning as date_maze_incorrect_beginning,
    date_maze_end as date_maze_adjusted_end,
    date_maze_end as date_maze_correct_end,
    date_maze_end as date_maze_incorrect_end,
    date_maze_middle as date_maze_adjusted_middle,
    date_maze_middle as date_maze_correct_middle,
    date_maze_middle as date_maze_incorrect_middle,
    date_orf_beginning as date_orf_accuracy_beginning,
    date_orf_beginning as date_orf_errors_beginning,
    date_orf_beginning as date_orf_wordscorrect_beginning,
    date_orf_end as date_orf_accuracy_end,
    date_orf_end as date_orf_errors_end,
    date_orf_end as date_orf_wordscorrect_end,
    date_orf_middle as date_orf_accuracy_middle,
    date_orf_middle as date_orf_errors_middle,
    date_orf_middle as date_orf_wordscorrect_middle,
    form_maze_beginning as form_maze_adjusted_beginning,
    form_maze_beginning as form_maze_correct_beginning,
    form_maze_beginning as form_maze_incorrect_beginning,
    form_maze_end as form_maze_adjusted_end,
    form_maze_end as form_maze_correct_end,
    form_maze_end as form_maze_incorrect_end,
    form_maze_middle as form_maze_adjusted_middle,
    form_maze_middle as form_maze_correct_middle,
    form_maze_middle as form_maze_incorrect_middle,
    form_orf_beginning as form_orf_accuracy_beginning,
    form_orf_beginning as form_orf_errors_beginning,
    form_orf_beginning as form_orf_wordscorrect_beginning,
    form_orf_end as form_orf_accuracy_end,
    form_orf_end as form_orf_errors_end,
    form_orf_end as form_orf_wordscorrect_end,
    form_orf_middle as form_orf_accuracy_middle,
    form_orf_middle as form_orf_errors_middle,
    form_orf_middle as form_orf_wordscorrect_middle,
    remote_maze_beginning as remote_maze_adjusted_beginning,
    remote_maze_beginning as remote_maze_correct_beginning,
    remote_maze_beginning as remote_maze_incorrect_beginning,
    remote_maze_end as remote_maze_adjusted_end,
    remote_maze_end as remote_maze_correct_end,
    remote_maze_end as remote_maze_incorrect_end,
    remote_maze_middle as remote_maze_adjusted_middle,
    remote_maze_middle as remote_maze_correct_middle,
    remote_maze_middle as remote_maze_incorrect_middle,
    remote_orf_beginning as remote_orf_accuracy_beginning,
    remote_orf_beginning as remote_orf_errors_beginning,
    remote_orf_beginning as remote_orf_wordscorrect_beginning,
    remote_orf_end as remote_orf_accuracy_end,
    remote_orf_end as remote_orf_errors_end,
    remote_orf_end as remote_orf_wordscorrect_end,
    remote_orf_middle as remote_orf_accuracy_middle,
    remote_orf_middle as remote_orf_errors_middle,
    remote_orf_middle as remote_orf_wordscorrect_middle,

    cast(null as float64) as national_dds_percentile_maze_correct_beginning,
    cast(null as float64) as national_dds_percentile_maze_correct_end,
    cast(null as float64) as national_dds_percentile_maze_correct_middle,
    cast(null as float64) as national_dds_percentile_maze_incorrect_beginning,
    cast(null as float64) as national_dds_percentile_maze_incorrect_end,
    cast(null as float64) as national_dds_percentile_maze_incorrect_middle,
    cast(null as float64) as national_dds_percentile_orf_errors_beginning,
    cast(null as float64) as national_dds_percentile_orf_errors_end,
    cast(null as float64) as national_dds_percentile_orf_errors_middle,
    cast(null as float64) as remote_composite_beginning,
    cast(null as float64) as remote_composite_end,
    cast(null as float64) as remote_composite_middle,
    cast(null as string) as benchmark_status_maze_correct_beginning,
    cast(null as string) as benchmark_status_maze_correct_end,
    cast(null as string) as benchmark_status_maze_correct_middle,
    cast(null as string) as benchmark_status_maze_incorrect_beginning,
    cast(null as string) as benchmark_status_maze_incorrect_end,
    cast(null as string) as benchmark_status_maze_incorrect_middle,
    cast(null as string) as benchmark_status_orf_errors_beginning,
    cast(null as string) as benchmark_status_orf_errors_end,
    cast(null as string) as benchmark_status_orf_errors_middle,
    cast(null as string) as form_composite_beginning,
    cast(null as string) as form_composite_end,
    cast(null as string) as form_composite_middle,
from data_farming
