select
    * except (
    ...
    if(exclude_fr_rank = 'true', 1, 0) as exclude_fr_rank,
    if(sched_loadlock = 'true', 1, 0) as sched_loadlock,
    if(sched_lockstudentschedule = 'true', 1, 0) as sched_lockstudentschedule,
    if(sched_scheduled = 'true', 1, 0) as sched_scheduled,
    if(state_enrollflag = 'true', 1, 0) as state_enrollflag,
