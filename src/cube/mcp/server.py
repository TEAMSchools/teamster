...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "dimensions — analyst-facing surfaces are views named "
        "`student_<domain>_<grain>` / `staff_<grain>` "
        "(e.g. `student_attendance_detail`, `student_attendance_summary`); "
        "(2) build a Cube "
        ...
        "(e.g. `student_attendance_summary.count_students`). Bare names won't resolve.\n\n"
