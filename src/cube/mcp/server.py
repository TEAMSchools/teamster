...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "Academic year convention: academic_year = 2025 means the 2025–26 "
        "school year (July 2025 – June 2026), not the year ending in 2025. "
        "This is the opposite of typical fiscal-year conventions where FY2025 "
        "ends in 2025. When a user says 'this year' or 'current year', use "
        "the academic_year value whose start year matches the current calendar "
        "year (e.g. if today is May 2026, current academic_year = 2025).\n\n"
        ...
        "(operator 'equals', value true) and group by academic_year. Returns "
